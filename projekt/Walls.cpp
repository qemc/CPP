...
Walls::Walls(const Vector2f& position, bool rotate) {

	setPosition(position);
	setFillColor(Color::White);
	setSize(Vector2f(300, 100));
	setOrigin(150, 50);
...
void Walls::bullet_collision(Player& player) {
	...
	if (player.main.getPosition().x + player.main.getGlobalBounds().width / 2 > 800) {
		player.main.setPosition(800 - player.main.getGlobalBounds().width / 2, player.main.getPosition().y);
	}
	...
	if (player.main.getPosition().y + player.main.getGlobalBounds().width / 2 > 800) {
		player.main.setPosition(player.main.getPosition().x, 800 - player.main.getGlobalBounds().width / 2);
	}
